    ...
    <>
      <main className="flex flex-row bg-gray-200 justify-between border p-4">
        ...
        <div className="flex flex-col w-32">
          ...
          <Link href="browse" className="text-black text-base">Browse</Link>
          <Link href="timeline" className="text-black text-base">Timeline</Link>
          <Link href="map" className="text-black text-base">Map</Link>
        </div>
